...
import RandomQ from "../images/RandomQ.webp"
import { IconTec } from "./iconTec"
import Link from "next/link"

export default function Proyect04(){
            ...
            <div className="grid grid-flow-row place-self-center min-[652px]:place-self-start min-[652px]:place-content-start gap-2">
                <div className="grid grid-flow-row place-content-center place-items-center place-self-center
                 min-[652px]:place-content-start min-[652px]:place-items-start min-[652px]:place-self-start">
                    <Link href="https://randomq123.netlify.app/"><h1 className="ProyectT text-2xl min-[400px]:text-3xl py-2">Random Quote</h1></Link>
                    ...
                    A quote generator that was made with HTML, CSS, Javascript, React and JQuery that show a random quote 
                    and color of the page, when you click the new quote button quote and color of the page changes.
                    It uses the old React Class syntax.
