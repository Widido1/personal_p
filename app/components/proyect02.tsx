...
import Sudoku from "../images/Sudoku.webp"
import { IconTec } from "./iconTec"
import Link from "next/link"

export default function Proyect02(){
            ...
            <div className="grid grid-flow-row place-self-center min-[652px]:place-self-start min-[652px]:place-content-start gap-2">
                <div className="grid grid-flow-row place-content-center place-items-center place-self-center
                 min-[652px]:place-content-start min-[652px]:place-items-start min-[652px]:place-self-start">
                    <Link href="https://sudoku-w.netlify.app/"><h1 className="ProyectT text-2xl min-[400px]:text-3xl py-2">Sudoku Generator</h1></Link>
                    ...
                    A Sudoku Generator made in React with a little bit of JQuery, it generates an empty sudoku
                    that can be resolved by the user or can resolve itself it the user want it.
                    </p>
                </div>
